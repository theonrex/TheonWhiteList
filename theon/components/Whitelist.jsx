	...
	const renderButton = () => {
		if (walletConnected) {
			if (joinedWhitelist) {
				...
				return <button className="explore_btn">Loading...</button>;
			} else {
				return (
						<button className="explore_btn" onClick={addAddressToWhitelist}> Join  Whitelist</button>
				);
			}
		}
		else {
		...
		//  else {
		// 	return <button > <WalletConnects/> </button>;
		// }
	}
